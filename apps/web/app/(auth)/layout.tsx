...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen w-full lg:grid lg:grid-cols-2 bg-background dark:bg-[#1a1a1a]">
      {/* Left Side - Form Area */}
      <div className="relative flex items-center justify-center p-8 lg:p-12 overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-sm space-y-8">
          ...
          <Link
            href="/"
            className="flex items-center gap-2 font-bold text-2xl text-foreground w-fit transition-opacity hover:opacity-80"
          >
          ...
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-1000">{children}</div>
